...
const Sidebar = ({ active }) => {
  ...
  return (
    <SidebarContainer style={{ overflowY: "auto" }} isOpen={isOpenSidebar}>
      <SidebarInner>
        <SidebarMenu>
          <ul>
            ...
            {role && (
              <>
                ...
                <li>
                  <NavLink
                    to="/staff_management/inactive_staff"
                    style={setActive(active, "inactive_staff")}
                  >
                    <FiUserMinus className={styles.iconSidebar} />
              ...
              <>
                ...
                <li>
                  <NavLink
                    ...
                    style={setActive(active, "property_providing_histories")}
                  >
